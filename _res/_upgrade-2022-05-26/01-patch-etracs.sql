...
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('verify-requirement', 'business_application', 'Verify Requirement', 'state', '1', '0', 'BPLS', 'BUSINESSINFO', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('ceo', 'business_application', 'Engineering', 'state', '4', '0', 'BPLS', 'CEO', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('assign-assessor', 'business_application', 'Assign Assessor', 'state', '5', '0', 'BPLS', 'ASSESSOR', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('assessment', 'business_application', 'Assessment', 'state', '9', '100', 'BPLS', 'ASSESSOR', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('approval', 'business_application', 'Approval', 'state', '10', '0', 'BPLS', 'APPROVER', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('reassessment', 'business_application', 'Reassessment', 'state', '14', '0', 'BPLS', 'ASSESSOR', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('forprinting', 'business_application', 'For Printing', 'state', '15', '0', 'BPLS', 'PRINTING', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('payment', 'business_application', 'For Payment', 'state', '20', '0', 'BPLS', 'APPROVER', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('assign-issuing-officer', 'business_application', 'Assign Issuing Officer', 'state', '90', '0', 'BPLS', 'LICENSING', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('release', 'business_application', 'For Issuance', 'state', '91', '0', 'BPLS', 'LICENSING', NULL, NULL, NULL);
INSERT INTO `sys_wf_node` (`name`, `processname`, `title`, `nodetype`, `idx`, `salience`, `domain`, `role`, `properties`, `ui`, `tracktime`) VALUES ('end', 'business_application', 'end', 'end', '99', '0', 'BPLS', NULL, NULL, NULL, NULL);

INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('start', 'business_application', '', 'verify-requirement', '1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('verify-requirement', 'business_application', '', 'assign-assessor', '1', NULL, '[caption:\"Submit\", icon: \"approve\"]', NULL, NULL, NULL);
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('ceo', 'business_application', 'submit', 'assign-assessor', NULL, NULL, '[caption:\"Submit\", confirm:\"Please ensure that all fees are correct. Proceed?\"]', NULL, NULL, NULL);
...
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('approval', 'business_application', 'submit', 'release', '0', NULL, '[\r\n  caption:\"Approve For Release\",\r\n  icon:\"approve\",\r\n  confirm: \'You are about to submit this for release. Proceed?\', \r\n  depends: \'currentSection\', \r\n  visibleWhen: \'#{(has_loaded_assessment == true && entity.totals.total == 0)}\'\r\n]', NULL, NULL, NULL);
...
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('forprinting', 'business_application', 'submit', 'payment', '0', NULL, '[caption:\"Submit\"]', NULL, 'Submit', NULL);
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('payment', 'business_application', 'release', 'assign-issuing-officer', '1', NULL, '[visible:false]', NULL, NULL, NULL);
...
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('assign-issuing-officer', 'business_application', '', 'release', '1', 'return true;', '[caption:\"Assign To Me\",    icon: \"approve\" ]', '', '', NULL);
...
INSERT INTO `sys_wf_transition` (`parentid`, `processname`, `action`, `to`, `idx`, `eval`, `properties`, `permission`, `caption`, `ui`) VALUES ('release', 'business_application', 'revert', 'payment', '3', NULL, '[caption:\"Return to Assessor\", messagehandler:\"default\", visible:false]', NULL, NULL, NULL);
