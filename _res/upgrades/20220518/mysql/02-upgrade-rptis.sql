...
alter table rptacknowledgement add dtchecked datetime
;
alter table rptacknowledgement_item add ref_objid varchar(50)
;
alter table rptacknowledgement_item add reftype varchar(50)
;
alter table rptacknowledgement_item add refno varchar(50)
;
